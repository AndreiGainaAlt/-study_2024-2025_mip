...
Создал файл lab4_2.tcl. И записал в него код, приведенный ниже:
...
Запустил программу с помощью NS-2. Получил nam файл со схемой моделируемой сети (рис. [-@fig:001])

![nam файл моделируемой сети](image/1.png){ #fig:001 width=70% }

Получил график изменения окна TCP на линке 1-го источника с помощью Xgraph (рис. [-@fig:002])

![График изменения окна TCP на линке 1-го источника при N = 20](image/2.png){ #fig:002 width=70% }

Получил график изменения окна TCP на всех источниках с помощью Xgraph (рис. [-@fig:003])

![График изменения окна TCP на всех источниках при N = 20](image/3.png){ #fig:003 width=70% }

Получил график изменения размера длины очереди с помощью Xgraph (рис. [-@fig:004])

![График изменения размера длины очереди при N = 20](image/4.png){ #fig:004 width=70% }

Получил график изменения средней длины очереди с помощью Xgraph (рис. [-@fig:005])
...
Получил график изменения размера окна TCP на линке 1-го источника (рис. [-@fig:006])

![График изменения размера окна TCP на линке 1-го источника при N = 20](image/8.png){ #fig:006 width=70% }

Получил график изменения размера окна TCP на всех источниках (рис. [-@fig:007])

![График изменения размера окна TCP на всех источниках при N = 20](image/9.png){ #fig:007 width=70% }

Получил график изменения размера длины очереди (рис. [-@fig:008])

![График изменения размера длины очереди при N = 20](image/7.png){ #fig:008 width=70% }

Получил график изменения размера средней длины очереди (рис. [-@fig:009])

![график изменения размера средней длины очереди при N = 20](image/6.png){ #fig:009 width=70% }
